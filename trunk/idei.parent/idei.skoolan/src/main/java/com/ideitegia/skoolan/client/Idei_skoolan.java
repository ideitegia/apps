...
import com.ideitegia.entity.model.Alumn;
import com.ideitegia.entity.model.Teacher;
...
//		RootPanel.get("errorLabelContainer").add(errorLabel);		
	    ...
	    alumn.setFirstName("Alumn");
	    Label alumnLabel = new Label("Hello " + alumn.getFirstName());
	    
	    Teacher teacher = new Teacher();
	    teacher.setFirstName("Teacher");
	    Label teacherLabel = new Label("Hello " + teacher.getFirstName());
	    ...
	    headerText1.setText("Skoolan Ikastola");
